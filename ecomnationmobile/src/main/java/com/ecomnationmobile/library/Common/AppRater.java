...
/**
 * Created by Chetan on 27/06/2016.
 */
public class AppRater {
    ...
    public static void app_launched(Context mContext, String title) {
        APP_TITLE = title;
    ...
    public static void showRateDialog(final Context mContext, final SharedPreferences.Editor editor) {
        ...
        tv.setText("If you enjoy using " + APP_TITLE + ", please take a moment to rate it on app store.");

...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    public void setTextSelector(int selectorId) {
        mTextSelector = selectorId;
    }
    /**
    ...
    protected TextView createDefaultTabView(Context context) {
        ...
        Typeface tf = Typeface.createFromAsset(context.getAssets(), "font/font.ttf");
        ...
        if(adapter != null) {
            for (int i = 0; i < adapter.getCount(); i++) {
                ...
                if(tabTitleView != null) {
                    ...
                    tabTitleView.setTextColor(getResources().getColorStateList(mTextSelector));
                }

...
/**
 * Created by Chetan on 18/10/2016.
 */
public class MobileEditText extends LinearLayout {

    TextView textView, prefixText;
    EditText editText;
    View view;
    ...
    public MobileEditText(final Context context, AttributeSet attrs, int defStyle) {
        ...
        view = LayoutInflater.from(context).inflate(R.layout.mobile_edittext, null);

        textView = (TextView) view.findViewById(R.id.txtLabel);
        prefixText = (TextView) view.findViewById(R.id.prefixText);
    ...
    public void init(String labelText, String prefixTxt) {
        textView.setText(labelText);
        prefixText.setText(prefixTxt);
    }

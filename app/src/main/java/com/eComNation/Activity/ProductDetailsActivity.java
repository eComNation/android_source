...
public class ProductDetailsActivity extends BaseDetailsActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        HelperClass.putSharedString(ProductDetailsActivity.this, "attribute_selection", null);
        HelperClass.putSharedString(ProductDetailsActivity.this, "product_option", null);
        ...
        buyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (attributes != null && !attributes.isEmpty()) {
                    ...
                    for (AttributeSpinner attr : attributes) {
                        if (attr.getSelectedPosition() < attr.getCount()) {
                            ...
                            Toast.makeText(ProductDetailsActivity.this, "Please select " + attr.getLabel().toLowerCase(), Toast.LENGTH_LONG).show();
                            return;
                        }
                    }
                ...
                if (addCount == 0 && (n_left == 0 || n_left >= quantity)) {
                    addCount++;
                    String content = HelperClass.getSharedString(ProductDetailsActivity.this, getString(R.string.cart));
                    ...
                    dialog.show();
                    Utility.getCart(ProductDetailsActivity.this, cart, new ECNCallback() {
                        @Override
                    ...
                    Toast.makeText(ProductDetailsActivity.this, "Selected quantity is unavailable", Toast.LENGTH_LONG).show();
                }
            }
        });
